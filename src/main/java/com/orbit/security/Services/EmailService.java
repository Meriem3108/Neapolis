...
public class EmailService {
    ...
    public void sendSimpleEmail(String toEmail,
        ...
        Session session = Session.getInstance(props, new javax.mail.Authenticator() {
            protected javax.mail.PasswordAuthentication getPasswordAuthentication() {
               // char[] password = "jhwwlvtllzoccvnh".toCharArray();
                return new PasswordAuthentication("noreply.pidev@gmail.com", "jhwwlvtllzoccvnh");
            }
        });
        ...
        try {
            ...
            message.setFrom(new InternetAddress("noreply.pidev@gmail.com"));
    ...
    public void receiveMail() {
        ...
        try {
            ...
            store.connect("imap.gmail.com", "noreply.pidev@gmail.com", "jhwwlvtllzoccvnh");
